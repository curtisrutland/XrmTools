...
namespace CurtisRutland.XrmTools.QueryBuilder
{
    public interface IQueryBuilder<Q> where Q : IQueryBuilder<Q>
    {
        ...
        Q WhereGreaterThan(string attributeName, int value);
        Q WhereGreaterThan(string attributeName, double value);
        Q WhereGreaterThan(string attributeName, decimal value);
        Q WhereGreaterOrEqual(string attributeName, int value);
        Q WhereGreaterOrEqual(string attributeName, double value);
        Q WhereGreaterOrEqual(string attributeName, decimal value);
        Q WhereLessThan(string attributeName, int value);
        Q WhereLessThan(string attributeName, double value);
        Q WhereLessThan(string attributeName, decimal value);
        Q WhereLessOrEqual(string attributeName, int value);
        Q WhereLessOrEqual(string attributeName, double value);
        Q WhereLessOrEqual(string attributeName, decimal value);
        Q WhereLike(string attributeName, string value);
